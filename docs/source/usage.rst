...
.. code-block:: console
      ...
      (ENV)$ python Example_Code/highlight_clade_strip.py


.. image:: Example_Data/Highlight_Clade_Strip.svg
...
We can also highlight these 7 clades using rings.
...
.. code-block:: console
      ...
      (ENV)$ python Example_Code/polar_nonultra_ring.py


.. image:: Example_Data/POLAR_NONULTRA_RING.svg
